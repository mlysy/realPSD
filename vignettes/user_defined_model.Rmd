...
We first define our fOU model in a C++ header file `fou.hpp`. To avoid potential scope conflict, we enclose the class definition within a user-defined namespace. 
