...
namespace OUR_MODEL {  
  ...
  ///
  /// This is the key for us to separate the customized UFun definition and the hidden FitMethods 
  /// provided by realPSD. 
  template<class Type>
...
We can compile and test the source file by using the following unit tests:

```{r, fou_tests, eval = FALSE}
require(TMB)
require(testthat)
