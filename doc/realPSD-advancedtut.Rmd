...
Since different methods use different names (`f` or `fbar`) for the frequency data, we need to choose the correct name for the frequency data before we can initialize the constructor.
