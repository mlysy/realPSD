...
\begin{figure}
  \begin{subfigure}
    \centering
    \resizebox{1.1\linewidth}{!}{\input{boxplot_Q.tex}}
    % \input{boxplot_Q.tex}
  \end{subfigure}
  \hfill
  \begin{subfigure}
    \centering
    \resizebox{1.1\linewidth}{!}{\input{boxplot_k.tex}}
    % \input{boxplot_k.tex}
  \end{subfigure}
  \hfill
  \begin{subfigure}
    \centering
    \resizebox{1.1\linewidth}{!}{\input{boxplot_f0.tex}}
    % \input{boxplot_f0.tex}
  \end{subfigure}
